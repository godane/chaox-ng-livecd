...
then
  _ln /usr/lib/nvidia/modules/drivers/nvidia_drv.so /usr/lib/xorg/modules/drivers/nvidia_drv.so 
...
then
  _ln /usr/lib/nvidia/modules/$(uname -r)/nvidia.ko /lib/modules/$(uname -r)/kernel/drivers/video/nvidia.ko
  depmod -A
