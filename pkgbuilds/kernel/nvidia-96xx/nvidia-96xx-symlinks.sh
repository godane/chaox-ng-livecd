_symlist="/etc/chaox-opengl-tools/nvidia-96xx-symlinks"
for lib in /usr/lib/nvidia-96xx/*.so*
do
...
then
  _ln /usr/lib/nvidia-96xx/modules/drivers/nvidia_drv.so /usr/lib/xorg/modules/drivers/nvidia_drv.so $_symlist
...
for ext in /usr/lib/nvidia-96xx/modules/extensions/*.so*
do
...
then
  _ln /usr/lib/nvidia-96xx/modules/$(uname -r)/nvidia.ko /lib/modules/$(uname -r)/kernel/drivers/video/nvidia.ko $_symlist
  depmod -A
